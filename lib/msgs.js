const msgs_texto = {
    ...
    info: {
        ...
        info:{
            ...
            "*Versão atual* : {p6}\n"+
            "*GitHub* : https://github.com/teonasnetto/bot-do-zap\n"
        },
        meusdados:{
        ...
        ping:{
            resposta: "Tempo de resposta : *{p1}* ms"
        }
    },
    figurinhas: {
        sticker:{
            ...
            error_save: '[❗] Houve um erro ao obter a mídia do video/imagem, tente novamente mais tarde.'
        },
        tps:{
    ...
    downloads: {
        ...
        fb: {
            ...
            sem_url: "[❗] URL não encontrada",
            erro_nao_identificado: "[❗] Houve um erro não identificado, verifique se o seu link está correto ou tente mais tarde.",
        },
        ig: {
            espera: "[AGUARDE] 🎬 Sua mídia está sendo baixada e processada.",
        ...
        tk: {
            ...
            erro_conversao: "[❗] Houve um erro na conversão de mídias do Tiktok, tente novamente mais tarde."
        },
        tw:{
            espera: "[AGUARDE] 🎬 Sua mídia está sendo baixada e processada.",
            nao_encontrado: "[❗] Mídia não encontrada, verifique o link.",
    ...
    grupo: {
        ...
        ativargrupo:{
            ligado: "✅ O grupo foi ativado com sucesso",
            desligado: "✅ O grupo foi desativado com sucesso"
        },
        antiporno:{
    ...
    diversao: {
        ...
        chance:{
            resposta: "🧩 *CHANCE* - Tem *{p1}%* de chance {p2}"
        },
        detector: {
    ...
    admin: {
        ...
        infocompleta:{
            ...
            "*Online desde* : {p3}\n"+
            "*Versão* : {p4}\n"+
            "*GitHub* : https://github.com/teonasnetto/whatsapp-bot\n"+
            "-------------------\n",
            resposta_variavel:{
                limite_diario: {
                    on: "*Limite diário* : ✅\n"+
