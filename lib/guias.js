...
module.exports = {
    ...
    figurinhas: {
        // TODO: atualizar comandos tps e atps
        s: cabecalho+
        ...
        save: cabecalho+
        "Ex: Responda uma imagem/video com *!save* - Salva a imagem atraves do bot.",
    },
    downloads: {
        // TODO: atualizar ytdl-core para play de musicas, "npm install ytdl-core@latest"
        play: cabecalho+
    ...
    utilidade : {
        stt: cabecalho+
        "Ex: Envie/responda um audio com *!stt* - Transforma o audio em texto.\n\n",
        tabela: cabecalho+
        ...
        // TODO: ajustar comando de conversão de tipos
        ...
        // TODO: ajustar comando de pesquisa de anime por similaridade
        anime:cabecalho+
        ...
        // TODO: atualizar api de lançamentos
        animelanc: cabecalho+
        "Ex: *!animelanc* - Mostra os ultimos lançamentos de anime do site AnimesHouse.",
        // TODO: configurar api para pesquisa de musica
    ...
    grupo:{
        // TODO: configurar regras , bugado demais
        regras: cabecalho+
        "Ex: *!regras* - Exibe a descrição/regras do grupo",
        status: cabecalho+
        "Ex: *!status* - Exibe as configurações atuais do grupo",
        // TODO: configurar adição e remoção da lista negra do grupo
        blista: cabecalho+
        ...
        // TODO: Configurar o antlink, classe principal confusa
        alink: cabecalho+
        ...
        // TODO: Configurar o antitrava, classe principal confusa
        atrava: cabecalho+
        ...
        // TODO: Configurar a api do anti-porno
        aporno: cabecalho+
        ...
        // TODO: Configurar para apagar mensagem de outras pessoas tambem caso o bot seja admin e a pessoa que tentou apagar tbm seja
        apg: cabecalho+
    ...
    diversao:{
        ...
        gadometro: cabecalho+
        "EX: *!gadometro* @membro - Mede o nível de gado do membro mencionado.\n\n",
        roll: cabecalho+
        "Ex: *!roll 2d20 + 3* - Rola um tipo de dado aleatoriamente entre os tipos de dados d4, d6, d8, d10, d12, d20, d100.\n"+
        "Obs: Pode colocar a quantidade de dados que deseja antes do dado ou somente o dado sem quantidade que será selecionado 1 dado somente, se quiser pode somar um valor de bonus ao resultado final.",
    },
    admin:{
        admin: cabecalho+
        ...
        gruposcadastrados: cabecalho+
        "Ex: *!gruposcadastrados* - Mostra os grupos cadastrados no bd do bot.",
        fotobot: cabecalho+
