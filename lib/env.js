...
module.exports = {
    criacaoEnv: async ()=>{
        ...
        let schema = {
         ...
         "NOME_ADMINISTRADOR=Teo\n"+
         "NOME_BOT=Teobot\n"+
         "NOME_AUTOR_FIGURINHAS = Teobot\n"+
         "DISCORD = ?????\n\n"
    ...
    verificarEnv:()=>{
        ...
        let resposta = {
            ...
            openai : {
              resposta: (process.env.OPENAI_API_KEY.trim() == "??????") ? "A API do OPENAI ainda não foi configurada" : "✓ API OPENAI Configurada.",
